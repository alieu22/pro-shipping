...
<section> 
  <div class="container-fluid bg-info p-2 mt-n4" style="max-height: 120px;">
    <div class="row align-items-end" style="height: 100%;">
      <div class="col-md-8 col-lg-6 align-self-start">
        <h1 style="margin-bottom: 10px;">Our Services</h1>
      ...
      <div class="col-md-4 col-lg-6 d-flex justify-content-end align-items-center">
        <img src="{{ asset('img/Driver.jpeg') }}" alt="Ps-picture" class="img-fluid rounded" style="max-width: 25%; margin-right: 120px; margin-bottom: 10px;">
      </div>
    </div>
    <div class="row">
